...
//                     driveStats.setFreeSpace(fResult ? SysUtils::ByteToStr(uliTotalFreeBytes.QuadPart) : "0");
                     if (fResult)
                        {
                     driveStats.setTotalSpace(SysUtils::ByteToStr(uliTotalNumBytes.QuadPart));
                     driveStats.setFreeSpace(SysUtils::ByteToStr(uliTotalFreeBytes.QuadPart));
                         }
                     else {
                     driveStats.setTotalSpace("0");
                     driveStats.setFreeSpace("0");
                        } ;
